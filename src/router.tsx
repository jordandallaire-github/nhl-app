import {
  ...
  const router = createBrowserRouter(
    ...
    ), { basename: "/projets/jdh/" /*Change the basename to your url project location ex : https://jordandallaire.ca/projets/dist/ dist being the folder containing all the project*/}
  );
