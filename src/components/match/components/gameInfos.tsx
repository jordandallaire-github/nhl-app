          ...
          >
            ...
            {infos.gameInfo.referees.length > 0 && (
              <div className="info referee">
                <p>Officiels :</p>
                <p>
                  {infos.gameInfo.referees.map((referee) => (
                    <span key={referee.default}>
                      {`${referee.default} - Arb.`}{" "}
                    </span>
                  ))}
                  {infos.gameInfo.linesmen.map((linesmen) => (
                    <span key={linesmen.default}>
                      {`${linesmen.default} - JL`}{" "}
                    </span>
                  ))}
                </p>
            ...
            {infos.gameInfo.awayTeam.scratches.length > 0 && (
              <div className="info scratche">
                ...
                <p>
                  {infos.gameInfo.awayTeam.scratches.map((scratche) => (
                    <>
                      <span key={scratche.id}>
            ...
            {infos.gameInfo.homeTeam.scratches.length > 0 && (
              <div className="info scratche">
                ...
                <p>
                  {infos.gameInfo.homeTeam.scratches.map((scratche) => (
                    <>
                      <span key={scratche.id}>
                        {scratche.firstName.default} {scratche.lastName.default}
                      </span>
